...
%         - Deemed cut of for phantom is 1650.
%         - Deemed average value for the phantom is 1902.
...
%                     abs(I(i+1,j-1)-I(i,j)) <= 260)
            ...
            elseif (i>=206 & i<=221 & j>=255 & j<=261 & k>=55 & k<=70)    % If top chamber hole.
                %                                            % %
            elseif (i>=234 & i<=239 & j>=255 & j<=261 & k>=55 & k<=70)    % If bottom chamber hole.
                %                                            % %
            else
